...
<div class="container">
 <div class="row">
 	...
 	<div class="col-lg-6">
 		...
 		<br>
 		<br>
 		<h3 style="font-size:30px;font-weight: bold;"><span style="color: deepskyblue;">Sign</span>Up</h3>
 		<br>
         ...
         <div class="form-group">
           ...
           <br>
           <input type="username" class="form-control" id="exampleInputUsername" aria-describedby="usernameHelp" placeholder="Enter Username" name="name" style="border: none;background: #f0f0f0;" required>
         </div>
         ...
         <div class="form-group">
           <label for="exampleInputEmail1">Email address</label>
            <br>
           <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" style="border: none;background: #f0f0f0;" name="email"  required>
         </div>
         ...
         <div class="form-group">
           ...
           <br>
           <button type="submit" name="register_btn" class="btn btn-primary col-sm-12 ">Signup</button>
           <br>
